...
const file_proto_auth_proto_rawDesc = "" +
	"\n" +
	"\x10proto/auth.proto\x12\vsupplychain\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9f\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\rLoginResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken2\x96\x01\n" +
	"\vAuthService\x12G\n" +
	"\bRegister\x12\x1c.supplychain.RegisterRequest\x1a\x1d.supplychain.RegisterResponse\x12>\n" +
	"\x05Login\x12\x19.supplychain.LoginRequest\x1a\x1a.supplychain.LoginResponseB\n" +
...
var file_proto_auth_proto_goTypes = []any{
	(*User)(nil),                  // 0: supplychain.User
	(*RegisterRequest)(nil),       // 1: supplychain.RegisterRequest
	(*RegisterResponse)(nil),      // 2: supplychain.RegisterResponse
	(*LoginRequest)(nil),          // 3: supplychain.LoginRequest
	(*LoginResponse)(nil),         // 4: supplychain.LoginResponse
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_proto_auth_proto_depIdxs = []int32{
	5, // 0: supplychain.User.created_at:type_name -> google.protobuf.Timestamp
	5, // 1: supplychain.RegisterResponse.created_at:type_name -> google.protobuf.Timestamp
	1, // 2: supplychain.AuthService.Register:input_type -> supplychain.RegisterRequest
	3, // 3: supplychain.AuthService.Login:input_type -> supplychain.LoginRequest
	2, // 4: supplychain.AuthService.Register:output_type -> supplychain.RegisterResponse
	4, // 5: supplychain.AuthService.Login:output_type -> supplychain.LoginResponse
